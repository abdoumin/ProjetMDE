...
/**
 * This is the item provider adapter for a {@link projet_hamlaoui.Microservice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MicroserviceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ProjetMdePackage.Literals.MICROSERVICE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProjetMdePackage.Literals.MICROSERVICE__PROPERTIES);
			childrenFeatures.add(ProjetMdePackage.Literals.MICROSERVICE__ENTITY);
			childrenFeatures.add(ProjetMdePackage.Literals.MICROSERVICE__ENUM);
			childrenFeatures.add(ProjetMdePackage.Literals.MICROSERVICE__DEPENDENCIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ProjetMdePackage.Literals.MICROSERVICE__PROPERTIES,
				ProjetMdeFactory.eINSTANCE.createProperties()));

		newChildDescriptors.add(createChildParameter(ProjetMdePackage.Literals.MICROSERVICE__ENTITY,
				ProjetMdeFactory.eINSTANCE.createEntity()));

		newChildDescriptors.add(createChildParameter(ProjetMdePackage.Literals.MICROSERVICE__ENUM,
				ProjetMdeFactory.eINSTANCE.createEnum()));

		newChildDescriptors.add(createChildParameter(ProjetMdePackage.Literals.MICROSERVICE__DEPENDENCIES,
				ProjetMdeFactory.eINSTANCE.createDependencies()));
	}
