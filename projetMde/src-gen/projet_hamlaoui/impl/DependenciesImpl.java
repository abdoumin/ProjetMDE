 ...
 * </p>
 * <ul>
 *   <li>{@link projet_hamlaoui.impl.DependenciesImpl#getDependency <em>Dependency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependenciesImpl extends MinimalEObjectImpl.Container implements Dependencies {
	...
	protected EClass eStaticClass() {
		return ProjetMdePackage.Literals.DEPENDENCIES;
	}
	...
	public EList<Dependency> getDependency() {
		if (dependency == null) {
			dependency = new EObjectContainmentEList<Dependency>(Dependency.class, this,
					ProjetMdePackage.DEPENDENCIES__DEPENDENCY);
		}
		return dependency;
	}
